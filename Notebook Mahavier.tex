...
\draw (.5, .866) -- (1, 0);
\draw(-.3, 1) node {Point B};
\draw (.5, -.25) node {Point A};
...
\draw [thick] (0,0) circle (1cm);
\draw [dashed] (-.5, -.866) -- (.5, .866);
\draw [dashed] (.5, -.866) -- (-.5, .866);
\draw [dashed] (-.866, -.5) -- (.866, .5);
\draw [dashed] (.866, -.5) -- (-.866, .5);

\draw (.75, 1.5) node [rotate=60] {$\frac{\sqrt{3}}{2}, \frac{1}{2}$};
\draw (1.5, .75) node [rotate=30] {$\frac{1}{2}, \frac{\sqrt{3}}{2}$};
\draw (-1, -1.5) node [rotate=60] {$-\frac{\sqrt{3}}{2}, -\frac{1}{2}$};
\draw (-1.75, -1) node [rotate=30] {$-\frac{1}{2}, -\frac{\sqrt{3}}{2}$};
\draw (1, -1.5) node [rotate=-60] {$\frac{\sqrt{3}}{2}, -\frac{1}{2}$};
\draw (1.75, -1) node [rotate=-30] {$\frac{1}{2}, -\frac{\sqrt{3}}{2}$};
\draw (-1, 1.5) node [rotate=-60] {$-\frac{\sqrt{3}}{2}, \frac{1}{2}$};
\draw (-1.75, 1) node [rotate=-30] {$-\frac{1}{2}, \frac{\sqrt{3}}{2}$};

\draw(.25, -1.5) node [rotate=-90] {(0,-1)};
\draw(1.5, 0) node {(1,0)};
\draw(.25, 1.5) node [rotate=90] {(0,1)};
\draw(-1.5, 0.25) node {(-1,0)};
\end{tikzpicture}
...
\textbf{Assignment 3: Problems 22-32}

\section{Problem 22}
\textit{Graph the function C, using the ordered pairs ( $\theta$ , C($\theta$)) computed in the previous problem.}
\\
\begin{tikzpicture}
\draw[step=1cm,gray,very thin] (-2,-2) grid (5,2); %grid body
\draw[thick, dashed] (-2,0) -- (0,0); %grid line
\draw[thick, dashed] (0,-2) -- (0,0); %grid line
\draw[thick, dashed] (0,0) -- (5,0) node[anchor=north west] {$\theta$}; %axis
\draw[thick, dashed] (0,0) -- (0,2) node[anchor=south east] {C($\theta$)}; %axis
\draw (-2,-2) node [anchor=north] {-2$\pi$};
\draw (-1,-2) node [anchor=north] {-$\pi$};
\draw (0,-2) node [anchor=north] {0};
\draw (1,-2) node [anchor=north] {$\pi$};
\draw (2,-2) node [anchor=north] {2$\pi$};
\draw (3,-2) node [anchor=north] {3$\pi$};
\draw (4,-2) node [anchor=north] {4$\pi$};
\draw (-2,0) node [anchor=east] {0};
\draw (-2,-1) node [anchor=east] {-1};
\draw (-2,1) node [anchor=east] {1};
%SELF DRAW THE GRAPH OF C(theta)
\end{tikzpicture}
...
\draw[thick, dashed] (0,-2) -- (0,0); %grid line
\draw[thick, dashed] (0,0) -- (5,0) node[anchor=north west] {$\theta$}; %axis
\draw[thick, dashed] (0,0) -- (0,2) node[anchor=south east] {S($\theta$)}; %axis
\draw (-2,-2) node [anchor=north] {-2$\pi$};
\draw (-1,-2) node [anchor=north] {-$\pi$};
\draw (0,-2) node [anchor=north] {0};
\draw (1,-2) node [anchor=north] {$\pi$};
...
\draw (-2,-1) node [anchor=east] {-1};
\draw (-2,1) node [anchor=east] {1};
%SELF DRAW THE GRAPH OF S(theta)
\end{tikzpicture}

\section{Problem 28} 
\textit{Solve S( $\theta$ ) = 1 for $\theta$.}
\\ \tab $\theta$ = $\frac{\pi}{2}$ and all values for which $\theta$ $\%$ $\pi$ = $\frac{\pi}{2}$

\section{Problem 29} 
\textit{Solve S( $\theta$ ) = $\frac{\sqrt{3}}{2}$ for $\theta$.}
\\ \tab $\theta$ = $\frac{\pi}{3}$ and all values for which $\theta$ $\%$ $\pi$ = $\frac{\pi}{3}$


\section{Problem 30} 
\textit{Solve S( $\theta$ ) = $-\frac{1}{2}$ for $\theta$.}
\\ \tab $\theta$ = $-\frac{\pi}{6}$ and all values for which $\theta$ $\%$ $\pi$ = $-\frac{\pi}{6}$
...
\draw[thick, dashed] (0,-2) -- (0,0); %grid line
\draw[thick, dashed] (0,0) -- (5,0) node[anchor=north west] {$\theta$}; %axis
\draw[thick, dashed] (0,0) -- (0,2) node[anchor=south east] { C($\theta$ + $\frac{\pi}{2}$)}; %axis
\draw (-2,-2) node [anchor=north] {-2$\pi$};
\draw (-1,-2) node [anchor=north] {-$\pi$};
\draw (0,-2) node [anchor=north] {0};
\draw (1,-2) node [anchor=north] {$\pi$};
